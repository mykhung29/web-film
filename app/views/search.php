        ...
        <div class="p-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-400">
                    Tìm thấy nhiều phim liên quan đến từ khóa <span class="text-white font-medium"><?= $keyword ?></span>.  
                    Một số gợi ý khác: 
                    <a href="#" class="text-primary hover:underline">abc 2</a>, 
                    <a href="#" class="text-primary hover:underline">abc remix</a>, 
                    <a href="#" class="text-primary hover:underline">abc full HD</a>.
                </p>
            </div>
                        ...
                        <div>
                            ...
                            <div class="space-y-2 max-h-48 overflow-y-auto pr-2">
                                <?php foreach ($categories_list as $cat): ?>
                                    <?php
                                        // Kiểm tra nếu slug đang được chọn trong GET (có thể là 1 string hoặc array)
                                        $selectedGenres = $_GET['theloai'] ?? [];
                                        $selectedGenres = is_array($selectedGenres) ? $selectedGenres : explode(',', $selectedGenres);
                                        $isChecked = in_array($cat['slug'], $selectedGenres);
                                    ?>
            ...
            <!-- Movies Grid -->
            <?php if ($total == 0): ?>
                <div class="flex flex-col items-center justify-center text-center py-16 px-4 rounded-xl border border-primary/20 shadow-lg mt-8">
                    <i class="fas fa-film text-5xl text-primary mb-4"></i>
                    <h2 class="text-white text-2xl font-bold mb-2">Không tìm thấy phim phù hợp</h2>
                    <p class="text-gray-400 max-w-xl">
                        Không tìm thấy phim nào phù hợp với yêu cầu của bạn.
                    </p>
                    <a href="/" class="mt-6 inline-block bg-primary text-white px-6 py-3 rounded-full hover:bg-opacity-90 transition">
                        Quay lại trang chủ
                    </a>
                </div>
            <?php else: ?>
